...
const Banner = ({ query, handleChange }) => {
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14 '>
      ...
      <p className='text-lg text-black/70 mb-8 '>Thousand of jobs in the computer, engineering are waiting for you.</p>
      <form>
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
          <div className='flex md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500 md:w-1/2 w-full'>
            <input
              ...
              value={query}
              name='title'
              className='block flex-1 border-0 bg-transparent py-1.5 pl-8 text-gray-900 placeholder-gray-500 sm:leading-6 focus:right-0'
              id='title'
