...
const Sallery = ({ handleChange, handleClick }) => {
  return (
    <div>
      <h4 className='text-lg font-medium mb-2 '>Sallary</h4>
      <div className='mb-4'>
      ...
      <div>
        ...
        <InputField handleChange={handleChange} value={"100"} title={" < 10000k"} name="test" />
      </div>
    </div>
  )
}
